...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ab_article', function (Blueprint $table) {
            ...
            $table->string('ab_description', 1000)->comment('Beschreibung, die die Güte oder die Beschaffenheit näher darstellt. Wird durch den "Ersteller" (ab_user) gepflegt.');
            $table->unsignedBigInteger('ab_creator_id')->comment('Referenz auf den/die Nutzer:in, der den Artikel erstellt hat und verkaufen möchte.');
